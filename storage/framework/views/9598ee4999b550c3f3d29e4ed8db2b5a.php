<?php $__env->startSection('title', 'Hesap Hareketleri - ' . ($settings->site_adi ?? 'BetNow')); ?>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-zinc-800/50 hover:bg-zinc-800/30 transition-colors">
                            ...
                            <td class="py-3 px-4">
                                <span class="px-2 py-1 text-xs rounded-full <?php echo e($transaction->type === 'win' ? 'bg-green-500/20 text-green-400' : ($transaction->type === 'bet' ? 'bg-red-500/20 text-red-400' : 'bg-blue-500/20 text-blue-400')); ?>">
                                    <?php echo e($transaction->type === 'win' ? 'Kazanç' : ($transaction->type === 'bet' ? 'Bahis' : ucfirst($transaction->type))); ?>

                                </span>
                            </td>
                            <td class="py-3 px-4 text-zinc-300 text-sm">
                                <?php if($transaction->gameid && $transaction->game): ?>
                                    <?php echo e($transaction->game->name ?? 'Oyun'); ?>

                                <?php else: ?>
                                    <?php echo e(ucfirst($transaction->type)); ?> işlemi
                                <?php endif; ?>
                            </td>
                            <td class="py-3 px-4 text-right">
                                <span class="font-medium <?php echo e($transaction->type === 'win' ? 'text-green-400' : ($transaction->type === 'bet' ? 'text-red-400' : 'text-blue-400')); ?>">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">
                        <?php echo e($user->parabirimi); ?><?php echo e(number_format($transactions->where('type', 'win')->sum('amount'), 2)); ?>
        ...
        <div class="bg-red-900/20 border border-red-500/30 rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">
                        <?php echo e($user->parabirimi); ?><?php echo e(number_format($transactions->where('type', 'bet')->sum('amount'), 2)); ?>
        ...
        <div class="bg-blue-900/20 border border-blue-500/30 rounded-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">
                        <?php echo e($user->parabirimi); ?><?php echo e(number_format($transactions->where('type', 'win')->sum('amount') - $transactions->where('type', 'bet')->sum('amount'), 2)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/robinbet118.com/httpdocs/resources/views/hesap-hareketleri.blade.php ENDPATH**/ ?>