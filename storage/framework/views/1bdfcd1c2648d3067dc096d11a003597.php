<?php $__env->startSection('title', 'Oyuncular'); ?>
...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div style="min-width: max-content;" class="flex items-center gap-2">
            <a href="<?php echo e(route('admin.users.export')); ?>" class="inline-flex items-center px-3 py-2 text-sm bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 rounded-lg hover:bg-yellow-500/20 transition-colors">
        ...
        <form method="GET" action="<?php echo e(route('admin.users')); ?>">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-3">
                <div class="relative md:col-span-2">
                    ...
                    <input type="text" name="search" class="w-full h-9 bg-zinc-900/50 border border-zinc-600/50 rounded-lg pl-10 pr-3 text-white text-sm placeholder-gray-500 focus:border-blue-500 focus:outline-none" placeholder="Kullanıcı adı, email veya ad" value="<?php echo e(request('search')); ?>">
                </div>
                <div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.users')); ?>" class="px-2 py-1.5 bg-zinc-700 text-white rounded-md hover:bg-zinc-600 transition-colors">
        ...
        <div class="bg-zinc-800/30 border border-zinc-700/50 rounded-lg p-3">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold text-white mt-1"><?php echo e($users->total()); ?></p>
                </div>
        ...
        <div class="bg-zinc-800/30 border border-zinc-700/50 rounded-lg p-3">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold text-green-400 mt-1"><?php echo e($users->where('durum', 1)->count()); ?></p>
                </div>
        ...
        <div class="bg-zinc-800/30 border border-zinc-700/50 rounded-lg p-3">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold text-purple-400 mt-1"><?php echo e($users->where('kayit_tarih', '>=', now()->startOfMonth())->count()); ?></p>
                </div>
        ...
        <div class="bg-zinc-800/30 border border-zinc-700/50 rounded-lg p-3">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-lg font-bold text-yellow-400 mt-1"><?php echo e(number_format($users->sum('bakiye'), 2)); ?></p>
                </div>
    ...
    <div class="bg-zinc-800/30 border border-zinc-700/50 rounded-lg p-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-xs text-gray-400">
                <?php echo e($users->firstItem()); ?>-<?php echo e($users->lastItem()); ?> / <?php echo e($users->total()); ?> oyuncu
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-800/50 transition-colors">
                        <td class="py-4 px-4 text-sm text-gray-300">#<?php echo e($user->id); ?></td>
                        <td class="py-4 px-4">
                        ...
                        <td class="py-4 px-4">
                            <div class="text-sm">
                                ...
                                <div class="text-gray-400"><?php echo e($user->telefon ?: 'Telefon yok'); ?></div>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <div class="text-sm">
                                <div class="text-white font-medium"><?php echo e($user->parabirimi); ?><?php echo e(number_format($user->bakiye, 2)); ?></div>
                                <div class="text-gray-400"><?php echo e($user->parabirimi); ?></div>
                            </div>
                        </td>
                        <td class="py-4 px-4 text-sm text-gray-300">
                            <?php echo e($user->kayit_tarih->format('d.m.Y H:i')); ?>

                        </td>
                        <td class="py-4 px-4 text-sm text-gray-300">
                            <?php if($user->songiris): ?>
                                <?php echo e(\Carbon\Carbon::parse($user->songiris)->format('d.m.Y H:i')); ?>
                        ...
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.user.details', $user->id)); ?>" class="p-2 text-gray-400 hover:text-yellow-500 hover:bg-yellow-500/10 rounded-lg transition-colors" title="Detaylar">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>
                                <button onclick="editUser(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', '<?php echo e($user->email); ?>', '<?php echo e($user->telefon); ?>', <?php echo e($user->bakiye); ?>, <?php echo e($user->durum); ?>, <?php echo e($user->aff ?? 0); ?>)" class="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-500/10 rounded-lg transition-colors" title="Düzenle">
        ...
        <div class="flex items-center justify-between mt-6 pt-6 border-t border-zinc-700">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php else: ?>
                    <a href="<?php echo e($users->previousPageUrl()); ?>" class="px-3 py-2 text-white bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-colors">Önceki</a>
                <?php endif; ?>
                ...
                <?php if($users->hasMorePages()): ?>
                    <a href="<?php echo e($users->nextPageUrl()); ?>" class="px-3 py-2 text-white bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-colors">Sonraki</a>
                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/robinbet777.com/httpdocs/resources/views/admin/users.blade.php ENDPATH**/ ?>