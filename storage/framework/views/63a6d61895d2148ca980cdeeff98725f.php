...
<?php $__env->startSection('title', 'Para Çekme Talepleri'); ?>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="stat-card-value"><?php echo e($withdrawals->total()); ?></p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="stat-card-value"><?php echo e($withdrawals->where('durum', 0)->count()); ?></p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="stat-card-value"><?php echo e($withdrawals->where('durum', 1)->count()); ?></p>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="stat-card-value"><?php echo e(number_format($withdrawals->where('durum', 1)->sum('miktar'), 2)); ?> TL</p>
                </div>
    ...
    <div class="content-card">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="text-sm text-gray-400">
                <?php echo e($withdrawals->firstItem()); ?>-<?php echo e($withdrawals->lastItem()); ?> / <?php echo e($withdrawals->total()); ?> talep
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-800/50 transition-colors">
                        <td class="py-4 px-4 text-sm text-gray-300">#<?php echo e($withdrawal->id); ?></td>
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full bg-red-500/20 flex items-center justify-center">
                                    <span class="text-red-500 font-semibold text-sm">
                                        <?php echo e(strtoupper(substr($withdrawal->user->name ?? 'U', 0, 1))); ?>

                                    </span>
                                </div>
                                <div>
                                    <div class="font-medium text-white"><?php echo e($withdrawal->user->name ?? 'Bilinmiyor'); ?></div>
                                    <div class="text-sm text-gray-400">ID: <?php echo e($withdrawal->user_id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <div class="text-sm">
                                <div class="text-white font-medium"><?php echo e(number_format($withdrawal->miktar, 2)); ?> TL</div>
                            </div>
                        </td>
                        <td class="py-4 px-4">
                            <div class="text-sm">
                                <div class="text-white"><?php echo e($withdrawal->banka); ?></div>
                                <?php if($withdrawal->sube): ?>
                                    <div class="text-gray-400">Şube: <?php echo e($withdrawal->sube); ?></div>
                                <?php endif; ?>
                                <?php if($withdrawal->hesap): ?>
                                    <div class="text-gray-400">Hesap: <?php echo e($withdrawal->hesap); ?></div>
                                <?php endif; ?>
                                <?php if($withdrawal->iban): ?>
                                    <div class="text-gray-400">IBAN: <?php echo e($withdrawal->iban); ?></div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="py-4 px-4 text-sm text-gray-300">
                            <?php echo e($withdrawal->tarih ? $withdrawal->tarih->format('d.m.Y H:i') : '-'); ?>
                        ...
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-2">
                                ...
                                <?php if($withdrawal->durum == 0): ?>
                                    <form method="POST" action="<?php echo e(route('admin.withdrawals.approve', $withdrawal->id)); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.withdrawals.reject', $withdrawal->id)); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="flex items-center justify-between mt-6 pt-6 border-t border-zinc-700">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php else: ?>
                    <a href="<?php echo e($withdrawals->previousPageUrl()); ?>" class="px-3 py-2 text-white bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-colors">Önceki</a>
                <?php endif; ?>
                ...
                <?php if($withdrawals->hasMorePages()): ?>
                    <a href="<?php echo e($withdrawals->nextPageUrl()); ?>" class="px-3 py-2 text-white bg-zinc-800 hover:bg-zinc-700 rounded-lg transition-colors">Sonraki</a>
                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/robinbet118.com/httpdocs/resources/views/admin/withdrawals.blade.php ENDPATH**/ ?>