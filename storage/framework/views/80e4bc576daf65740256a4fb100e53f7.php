<?php $__env->startSection('title', $settings->site_adi ?? 'BetNow - Türkiye\'nin En Güvenilir Online Casino Platformu'); ?>
    ...
    <?php $__currentLoopData = $homeSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php switch($section->name):
            case ('slider'): ?>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="relative w-full overflow-hidden">
                                    <img src="<?php echo e(asset($slider->gorsel)); ?>" alt="Slider" class="block w-full h-auto object-contain" loading="eager">
                                </div>
                                <?php if($slider->baslik): ?>
                                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 md:p-6">
                                    <h2 class="text-white text-lg md:text-xl lg:text-2xl font-bold"><?php echo e($slider->baslik); ?></h2>
                                    <?php if($slider->aciklama): ?>
                                    <p class="text-gray-200 text-sm md:text-base mt-2"><?php echo e($slider->aciklama); ?></p>
                                    <?php endif; ?>
                                </div>
                                <?php endif; ?>
                                <?php if($slider->url): ?>
                ...
                <?php if(($settings->bottom_banner_active ?? 0) == 1 && !empty($settings->bottom_banner_image)): ?>
                <section class="px-4 mt-3">
                    <div class="max-w-7xl mx-auto">
                        <div class="relative w-full rounded-xl overflow-hidden border border-zinc-800/60 shadow-sm">
                            <?php if(!empty($settings->bottom_banner_url)): ?>
                                <a href="<?php echo e($settings->bottom_banner_url); ?>" target="_blank" rel="noopener" class="block">
                                    <img src="<?php echo e(asset($settings->bottom_banner_image)); ?>" alt="Alt Banner" class="w-full h-auto object-cover">
                                </a>
                            <?php else: ?>
                                <img src="<?php echo e(asset($settings->bottom_banner_image)); ?>" alt="Alt Banner" class="w-full h-auto object-cover">
                            <?php endif; ?>
                        </div>
                        <?php if(isset($bottomBannerBelowImages) && $bottomBannerBelowImages->count() > 0): ?>
                        <div class="mt-3">
                            <?php if(($settings->bottom_below_mobile_grid ?? 0) == 1): ?>
                                <div class="grid gap-2" style="grid-template-columns: repeat(<?php echo e($bottomBannerBelowImages->count()); ?>, minmax(0, 1fr));">
                                    <?php $__currentLoopData = $bottomBannerBelowImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($bb->url): ?>
                                            <a href="<?php echo e($bb->url); ?>" target="_blank" rel="noopener" class="block">
                                                <img src="<?php echo e(asset($bb->gorsel)); ?>" alt="Alt Banner Altı" class="w-full h-auto rounded-lg border border-zinc-800/60" loading="lazy">
                                            </a>
                                        <?php else: ?>
                                            <img src="<?php echo e(asset($bb->gorsel)); ?>" alt="Alt Banner Altı" class="block w-full h-auto rounded-lg border border-zinc-800/60" loading="lazy">
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <style>
                            ...
                            <?php else: ?>
                                <div class="flex gap-2">
                                    <?php $__bbCount = max(1, $bottomBannerBelowImages->count()); $__gap = 8; ?>
                                    <?php $__currentLoopData = $bottomBannerBelowImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $__width = 'calc((100% - ' . ($__bbCount - 1) * $__gap . 'px)/' . $__bbCount . ')'; ?>
                                        <?php if($bb->url): ?>
                                            <a href="<?php echo e($bb->url); ?>" target="_blank" rel="noopener" class="block" style="width: <?php echo e($__width); ?>;">
                                                <img src="<?php echo e(asset($bb->gorsel)); ?>" alt="Alt Banner Altı" class="w-full h-auto rounded-lg border border-zinc-800/60" loading="lazy">
                                            </a>
                                        <?php else: ?>
                                            <img src="<?php echo e(asset($bb->gorsel)); ?>" alt="Alt Banner Altı" class="block w-full h-auto rounded-lg border border-zinc-800/60" style="width: <?php echo e($__width); ?>;" loading="lazy">
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php endif; ?>
            ...
            <?php case ('son_kazananlar'): ?>
                <!-- Son Kazananlar Section -->
                <?php if($recentWinners->count() > 0): ?>
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="mb-4">
                            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-zinc-900/50 via-zinc-900/30 to-transparent border border-zinc-800/50 p-3 sm:p-4">
                                ...
                                <div class="relative flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 class="text-base sm:text-xl font-bold bg-clip-text text-transparent" style="background: linear-gradient(to right, #ebff00, #ebff00, #ebff00); -webkit-background-clip: text; background-clip: text; color: transparent;"><?php echo e($section->title); ?></h2>
                        ...
                        <div class="relative overflow-hidden">
                            <div class="recent-winners-scroll flex gap-2 md:gap-3 animate-scroll-winners">
                                <?php $__currentLoopData = $recentWinners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $winner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!-- Winner Card -->
                                <div class="winner-card group flex-shrink-0 bg-gradient-to-br from-zinc-900/90 via-zinc-800/80 to-zinc-900/70 rounded-lg border border-zinc-700/50 px-1 py-0.5 w-auto hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-red-500/20 backdrop-blur-sm">
                                    <div class="flex items-center gap-1.5">
                                        <a href="/GameLaunch/<?php echo e($winner->gameid); ?>" target="_blank" class="block">
                                            <div class="w-12 h-12 md:w-16 md:h-16 rounded-md overflow-hidden border border-zinc-600/30 bg-zinc-900/60 flex items-center justify-center relative">
                                                <?php if($winner->cover): ?>
                                                    <img src="<?php echo e(asset($winner->cover)); ?>" alt="Kazanan oyun" class="w-full h-full object-contain">
                                                <?php else: ?>
                                        ...
                                        <div class="min-w-0 flex flex-col">
                                            <span class="text-white text-xs font-medium truncate"><?php echo e($winner->masked_username); ?></span>
                                            <span class="text-yellow-400 font-bold text-[11px] md:text-xs whitespace-nowrap"><?php echo e(number_format($winner->amount, 0)); ?>₺</span>
                                            <span class="text-zinc-500 text-[10px] md:text-xs whitespace-nowrap"><?php echo e($winner->created_at->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-3">
                            <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-zinc-900/50 via-zinc-900/30 to-transparent border border-zinc-800/50 p-3">
                                ...
                                <div class="relative flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 class="text-base sm:text-lg font-bold bg-clip-text text-transparent" style="background: linear-gradient(to right, #ebff00, #ebff00, #ebff00); -webkit-background-clip: text; background-clip: text; color: transparent;"><?php echo e($section->title); ?></h2>
                            ...
                            <div class="match-card bg-gradient-to-br from-zinc-900/80 via-zinc-900/60 to-zinc-900/40 rounded-lg border border-zinc-800/50 p-2 hover:scale-102 transition-all duration-300 shadow-lg hover:shadow-red-500/10">
                                ...
                                <div class="flex items-center justify-between mb-2">
                                    <div class="flex items-center gap-1">
                                        ...
                                        <span class="text-zinc-400 text-xs truncate"><?php echo e(Str::limit($match->lig_isim, 12)); ?></span>
                                    </div>
                                    <span class="text-zinc-500 text-xs"><?php echo e(Str::limit($match->ulke_isim, 8)); ?></span>
                                </div>

                                <!-- Teams -->
                                <div class="mb-2">
                                    <div class="flex items-center justify-center gap-1 mb-1">
                                        <h3 class="text-white font-medium text-xs truncate flex-1 text-center"><?php echo e(Str::limit($match->evsahibi_isim, 12)); ?></h3>
                                        <span class="text-zinc-400 text-xs">vs</span>
                                        <h3 class="text-white font-medium text-xs truncate flex-1 text-center"><?php echo e(Str::limit($match->misafir_isim, 12)); ?></h3>
                                    </div>
                                    
                                    <!-- Match Time -->
                                    <div class="text-center">
                                        <p class="text-red-400 font-medium text-xs">
                                            <?php echo e(\Carbon\Carbon::parse($match->baslangic)->format('d.m H:i')); ?>

                                        </p>
                                        <p class="text-zinc-500 text-xs">
                                            <?php echo e(\Carbon\Carbon::parse($match->baslangic)->diffForHumans()); ?>
                                ...
                                <div class="grid grid-cols-3 gap-0.5">
                                    ...
                                    <a href="/sports" class="bg-zinc-800/50 rounded-sm p-1.5 text-center hover:bg-zinc-700/50 transition-colors cursor-pointer border border-zinc-700/30 hover:border-red-500/30 block">
                                        ...
                                        <p class="text-white font-semibold text-xs"><?php echo e(number_format($match->oran1, 2)); ?></p>
                                    </a>
                                    
                                    <!-- Draw -->
                                    <a href="/sports" class="bg-zinc-800/50 rounded-sm p-1.5 text-center hover:bg-zinc-700/50 transition-colors cursor-pointer border border-zinc-700/30 hover:border-red-500/30 block">
                                        <p class="text-zinc-400 text-xs mb-0.5">X</p>
                                        <p class="text-white font-semibold text-xs"><?php echo e(number_format($match->oran0, 2)); ?></p>
                                    </a>
                                    
                                    <!-- Away Win -->
                                    <a href="/sports" class="bg-zinc-800/50 rounded-sm p-1.5 text-center hover:bg-zinc-700/50 transition-colors cursor-pointer border border-zinc-700/30 hover:border-red-500/30 block">
                                        <p class="text-zinc-400 text-xs mb-0.5">2</p>
                                        <p class="text-white font-semibold text-xs"><?php echo e(number_format($match->oran2, 2)); ?></p>
                                    </a>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="horizontal-scroll flex overflow-x-auto gap-2 pb-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                            <?php $__currentLoopData = $oyunlar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oyun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="oyun-card bg-zinc-900/90 rounded-2xl shadow-lg hover:scale-105 transition-all duration-300 border border-zinc-800 flex-shrink-0 relative">
                                    <a href="<?php echo e($oyun->url ?? '#'); ?>" target="_blank" class="block">
                                        <div class="w-[140px] h-[250px] overflow-hidden rounded-2xl relative">
                                            ...
                                            <img src="<?php echo e(asset($oyun->gorsel)); ?>" alt="oyun" class="w-full h-full object-cover opacity-0 transition-opacity duration-500 absolute inset-0" 
            ...
            <?php case ('casino_oyunlari'): ?>
                ...
                <section class="py-2 px-4">
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="horizontal-scroll flex overflow-x-auto gap-2 pb-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                            <?php $__currentLoopData = $casinoOyunlari; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oyun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="oyun-card bg-zinc-900/90 rounded-2xl shadow-lg hover:scale-105 transition-all duration-300 border border-zinc-800 flex-shrink-0 relative">
                                    <a href="<?php echo e($oyun->url ?? '#'); ?>" target="_blank" class="block">
                                        <div class="w-[140px] h-[250px] overflow-hidden rounded-2xl relative">
                                            <!-- Loading Skeleton with Shimmer Effect -->
                                            ...
                                            <!-- Actual Image (hidden initially) -->
                                            <img src="<?php echo e(asset($oyun->gorsel)); ?>" alt="casino oyun" class="w-full h-full object-cover opacity-0 transition-opacity duration-500 absolute inset-0" 
                                                 onload="this.style.opacity='1'; this.previousElementSibling.style.display='none';">
                                        </div>
                                    </a>
                                </div>
            ...
            <?php case ('canli_casinolar'): ?>
                ...
                <section class="py-2 px-4">
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="horizontal-scroll flex overflow-x-auto gap-2 pb-4 scrollbar-hide" style="scrollbar-width: none; -ms-overflow-style: none;">
                            <?php $__currentLoopData = $canliCasino; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oyun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="oyun-card bg-zinc-900/90 rounded-2xl shadow-lg hover:scale-105 transition-all duration-300 border border-zinc-800 flex-shrink-0 relative">
                                    <a href="<?php echo e($oyun->url ?? '#'); ?>" target="_blank" class="block">
                                        <div class="w-[140px] h-[250px] overflow-hidden rounded-2xl relative">
                                            <!-- Loading Skeleton with Shimmer Effect -->
                                            ...
                                            <!-- Actual Image (hidden initially) -->
                                            <img src="<?php echo e(asset($oyun->gorsel)); ?>" alt="canlı casino" class="w-full h-full object-cover opacity-0 transition-opacity duration-500 absolute inset-0" 
                                                 onload="this.style.opacity='1'; this.previousElementSibling.style.display='none';">
                                        </div>
                                    </a>
                                </div>
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900/50 via-zinc-900/30 to-transparent border border-zinc-800/50 shadow-2xl">
            ...
            <div class="relative p-6">
                ...
                <div class="text-center mb-6">
                    ...
                    <div class="duyuru-content" data-duyuru-id="<?php echo e($duyuru->id); ?>">
                        <?php if($duyuru->resim): ?>
                        <div class="mb-4">
                            <img src="<?php echo e(asset($duyuru->resim)); ?>" alt="Duyuru" class="w-full max-h-64 object-contain rounded-lg bg-zinc-800/30">
                        </div>
                        <?php endif; ?>
                        
                        <h3 class="text-xl font-bold bg-gradient-to-r from-red-500 via-red-400 to-red-500 bg-clip-text text-transparent mb-3"><?php echo e($duyuru->konu); ?></h3>
                        
                        <?php if($duyuru->aciklama): ?>
                        <div class="text-zinc-300 text-sm leading-relaxed mb-6">
                            <?php echo nl2br(e($duyuru->aciklama)); ?>

                        </div>
                        <?php endif; ?>
                        
                        <?php if($duyuru->url): ?>
                        <a href="<?php echo e($duyuru->url); ?>" class="inline-block mb-4 px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 text-sm">
                            Detayları Gör
                        </a>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/robinbet118.com/httpdocs/resources/views/home.blade.php ENDPATH**/ ?>