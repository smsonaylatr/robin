    ...
    <div class="text-center max-w-2xl mx-auto">
        ...
        <div class="glass-effect rounded-2xl p-8 md:p-12 mb-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('home') }}" class="casino-gradient text-black font-bold py-3 px-8 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                ...
                <a href="{{ route('casino') }}" class="bg-zinc-800/60 hover:bg-zinc-700/60 text-white font-bold py-3 px-8 rounded-lg border border-zinc-700 hover:border-red-500/50 transition-all duration-300">
                    <svg class="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="glass-effect rounded-2xl p-6">
            ...
            <div style="display: inline-flex;" class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('casino') }}" class="group">
                ...
                <a href="{{ route('live-casino') }}" class="group">
                    <div class="bg-zinc-800/50 rounded-lg p-4 hover:bg-zinc-700/50 transition-all duration-300 transform hover:scale-105">
                ...
                <a href="{{ route('sports') }}" class="group">
                    <div class="bg-zinc-800/50 rounded-lg p-4 hover:bg-zinc-700/50 transition-all duration-300 transform hover:scale-105">
