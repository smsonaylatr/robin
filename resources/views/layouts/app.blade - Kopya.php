            ...
            <div class="py-3 px-1 flex-1 h-full overflow-y-auto">
                ...
                <div class="mb-4">
                    ...
                    <div class="space-y-1">
                        ...
                        <a class="flex uppercase items-center gap-2 px-3 py-1.5 mx-2 rounded-sm border active:scale-[0.98] transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] text-gray-400 hover:bg-muted/20 hover:text-white cursor-pointer" onclick="openLiveChat()">
                            <div class="w-8 h-8 rounded-sm flex items-center justify-center transition-colors duration-200 bg-green-600/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-headset w-5 h-5 text-white" aria-hidden="true">
                                    <path d="M3 18v-6a9 9 0 0 1 18 0v6"></path>
                                    <path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3"></path>
                                </svg>
                            </div>
                            <span class="text-sm font-medium text-green-400">Canlı Destek</span>
                        </a>
                    </div>
                </div>
