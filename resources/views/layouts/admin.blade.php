                        ...
                        <div class="mx-auto px-2 sm:px-4">
                            <div class="flex items-center justify-between h-14 sm:h-16">
                                <div class="flex items-center gap-2 sm:gap-4">
                                    ...
                                    <a class="flex items-center gap-1.5 sm:gap-2 text-base sm:text-lg md:text-2xl font-semibold md:font-bold text-red-500 hover:text-red-400 transition-colors" href="{{ route('admin.dashboard') }}">
                                ...
                                <div class="flex items-center gap-2 sm:gap-3 md:gap-4">
                                    ...
                                    <div class="user-dropdown">
                                        ...
                                        <div id="user-dropdown-menu" class="user-dropdown-menu">
                                            ...
                                            <a href="{{ route('admin.clear-cache') }}" class="user-dropdown-item" onclick="event.preventDefault(); document.getElementById('clear-cache-form').submit();">
