...
@section('title', 'Giriş Yap - ' . $settings->site_kelimeler)
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900/50 via-zinc-900/30 to-transparent border border-zinc-800/50 p-8 shadow-2xl">
            <div class="absolute inset-0 bg-[url('{{ asset('assets/noise.png') }}')] opacity-70 pointer-events-none"></div>
            ...
            <form method="POST" action="{{ route('login') }}" class="relative space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.forgot') }}" class="text-sm transition-colors" style="color: #ebff00;" onmouseover="this.style.color='#ebff00'" onmouseout="this.style.color='#ebff00'">Şifremi unuttum</a>
                </div>
