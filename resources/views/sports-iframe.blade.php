...
@section('title', 'Spor Bahisleri - Betlucky')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allowedOrigin = new URL('{{ $sportsApi->api_url }}').origin;
...
async function initializeSportsIframe() {
    ...
    try {
        ...
        const authData = {
            api_secret_key: '{{ $sportsApi->api_secret_key }}',
        ...
        const response = await fetch('{{ route('sports.login') }}', {
            method: 'POST',
            headers: {
